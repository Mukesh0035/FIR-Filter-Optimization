...
User: buet   Host: cadence   HostID: 7F0100   PID: 6667
Memory  available: 6.6765 GB  physical: 7.8061 GB
CPU Type: AMD Ryzen 7 4800H with Radeon Graphics         
...
Simulating `input.scs' on cadence at 2:50:02 PM, Fri Aug 1, 2025 (process id: 6667).
Current working directory: /home/buet/simulation/6TSRAM/spectre/schematic/netlist.
Command line:
    /home/buet/cadence/MMSIM121/tools.lnx86/spectre/bin/32bit/spectre  \
        input.scs +escchars +log ../psf/spectre.out +inter=mpsc  \
        +mpssession=spectre0_4032_1 -format psfxl -raw ../psf  \
...
Reading file:  /home/buet/simulation/6TSRAM/spectre/schematic/netlist/input.scs
...
Time for NDB Parsing: CPU = 752.884 ms, elapsed = 713.943 ms.
Time accumulated: CPU = 752.884 ms, elapsed = 713.943 ms.
Peak resident memory used = 32.3 Mbytes.


Time for Elaboration: CPU = 37.995 ms, elapsed = 39.6831 ms.
Time accumulated: CPU = 791.879 ms, elapsed = 754.244 ms.
Peak resident memory used = 34.7 Mbytes.


Time for EDB Visiting: CPU = 4.998 ms, elapsed = 7.85303 ms.
Time accumulated: CPU = 797.877 ms, elapsed = 762.388 ms.
...
Time for parsing: CPU = 9 ms, elapsed = 20.318 ms.
Time accumulated: CPU = 806.877 ms, elapsed = 782.905 ms.
Peak resident memory used = 35.8 Mbytes.

Entering remote command mode using MPSC service (spectre, ipi, v0.0, spectre0_4032_1, ).
...
Total time required for dc analysis `dcOp': CPU = 6.998 ms, elapsed = 8.44312 ms.
Time accumulated: CPU = 818.874 ms, elapsed = 846.027 ms.
Peak resident memory used = 36.5 Mbytes.

dcOpInfo: writing operating point information to rawfile.

****************************************
DC Analysis `dc': V5:dc = (0 V -> 1.8 V)
****************************************
Important parameter values:
    reltol = 1e-03
    abstol(V) = 1 uV
...
Total time required for dc analysis `dc': CPU = 7.999 ms, elapsed = 9.94301 ms.
Time accumulated: CPU = 835.872 ms, elapsed = 867.07 ms.
