...
HD_PWD='C:/Users/mukul/Vivado Projects/Fir_Filter/Fir_Filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_uart_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fir_uart_top.tcl -notrace
