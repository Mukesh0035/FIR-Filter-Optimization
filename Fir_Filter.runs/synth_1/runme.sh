...
HD_PWD='C:/Users/mukul/Vivado Projects/Fir_Filter/Fir_Filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_uart_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_uart_top.tcl
